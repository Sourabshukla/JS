...
//The output will be false because "sourab" is a string, not an array. Therefore, Array.isArray() 
//confirms that the provided value is not an array.



//   console.log(Array.from("sourab")); //[ 's', 'o', 'u', 'r', 'a', 'b' ]
//   from=>Creates an array from an iterable object.
// console.log(Array.from({name:"sourab"})); //[] gives empty array // intresting case in interview
